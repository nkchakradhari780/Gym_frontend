...
const PlanPage = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post(
                'http://localhost:3001/manager/plans/create',
                {
                    planID,
                    planName,
                    level,
            ...
            router.push("/dashboard-manager/plans");
        } catch (error) {
    ...
    useEffect(() => {
        const fetchTrainersList = async () => {
            try {
                const trainer = await axios.get('http://localhost:3001/manager/trainer', {
                    withCredentials: true,
                });
    ...
    return (
        <div className={styles.container}>
            <div className={styles.top}>
                ...
                <Link href="/dashboard-manager/plans">
