...
const PlanPage = () => {
  ...
  useEffect(() => {
    const fetchPlansList = async () => {
      try {
        const response = await axios.get('http://localhost:3001/manager/plans', {
  ...
  const handleDelete = async (index, planId) => {
    ...
    try {
      await axios.delete(`http://localhost:3001/manager/plans/${planId}`, {
        withCredentials: true,
      });
    ...
    <div className="min-h-screen bg-gray-900 text-gray-200 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          /> */}
          <Link href="/dashboard-manager/plans/add-plan">
          ...
          {planList.map((plan, index) => (
            ...
            >
              ...
              <div className="flex justify-between items-center mt-6">
                <Link href={`/dashboard-manager/plans/update/${plan._id}`}>
