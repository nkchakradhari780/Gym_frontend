...
const EquipmentPage = () => {
    ...
    const fetchEquipmentsList = async () => {
      try {
        const response = await axios.get(
          "http://localhost:3001/manager/equipment",
  ...
  const deleteEquipment = async (id) => {
    ...
    try {
      const response = await axios.delete(`http://localhost:3001/manager/equipment/${id}`, {
        withCredentials: true,
      });
  ...
  return (
    <div className={styles.container}>
      <div className={styles.top}>
        ...
        <Link href="/dashboard-manager/equipments/add-equipment">
              ...
              <tr key={equipment._id}>
                ...
                <td>
                  <div className={styles.buttons}>
                    <Link
                      href={`/dashboard-manager/equipments/update/${equipment.id}`}
                    >
